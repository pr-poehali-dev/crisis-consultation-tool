      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/80 text-base leading-relaxed">
              Через полтора года я стал старшим барменом. Потом — бар-менеджером и шеф-барменом. Потом — управляющим. Каждая ступень открывала новую картину: персонал, который не продаёт; меню, которое съедает маржу; владельцы, которые работают на заведение, а не заведение на них.
            </p>
          </div>
        </div>
