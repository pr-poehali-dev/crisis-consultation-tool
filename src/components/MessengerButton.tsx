  ...
  return (
    <div className="fixed right-4 bottom-24 z-50 flex flex-col items-end gap-2">
      {open && (
        <div className="flex flex-col gap-2 mb-2 animate-fade-in">
          <a
            ...
            className="flex items-center gap-3 bg-[#229ED9] text-white text-sm font-semibold px-4 py-3 rounded-2xl shadow-2xl hover:brightness-110 transition-all whitespace-nowrap"
      ...
      <button
        ...
        style={{ background: open ? "#FF6B00" : "#229ED9" }}
      ...
      >
        ...
        {!open && (
          <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#FF6B00] rounded-full flex items-center justify-center">
