...
export default function PainsSection() {
  ...
  return (
    <section className="py-16 px-4 bg-[#1A120B]">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-lime/10 border border-lime/30 rounded-full px-4 py-1.5 mb-4">
            <Icon name="AlertCircle" size={14} className="text-lime" />
            <span className="text-lime text-sm font-medium">Узнаёте себя?</span>
          </div>
        ...
        {checked.length >= 3 && (
          <div className="bg-[#FF7A1A]/10 border border-[#FF7A1A]/30 rounded-2xl p-6 text-center animate-fade-in">
            ...
            <button
              ...
              className="bg-[#FF7A1A] hover:bg-[#D9520A] text-white font-semibold px-8 py-3 rounded-xl transition-colors"
            >
