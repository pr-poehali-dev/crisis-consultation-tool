...
export default function AuditSection() {
  ...
  return (
    <section className="py-16 px-4 bg-[#121926]" id="audit">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-[rgba(208, 88, 94, 0.1)] border border-[rgba(208, 88, 94, 0.3)] rounded-full px-4 py-2 mb-6">
            <Icon name="Search" size={16} className="text-[#D0585E]" />
            <span className="text-[#D0585E] text-sm font-medium uppercase tracking-wider">Бесплатно</span>
          </div>
        ...
        {done ? (
          <div className="glass-card rounded-2xl p-10 text-center">
            ...
            <p className="text-[#DB8084] font-medium">Обычно ответ приходит в течение нескольких часов.</p>
            <ContactFallback />
          </div>
        ) : (
          <div className="glass-card rounded-2xl overflow-hidden">
            ...
            <div className="h-1.5 bg-[rgba(255,255,255,0.06)]">
              <div
                className="h-full bg-[#D0585E] transition-all duration-500"
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 rounded-full bg-[#D0585E] flex items-center justify-center text-[#121926] font-bold text-sm flex-shrink-0">
                  {step + 1}
                </div>
                        ...
                        {q.options!.map((opt) => (
                          <button
                            ...
                            className={`px-3 py-2.5 rounded-xl text-sm text-left transition-all duration-200 border ${
                              answers[q.id] === opt
                                ? "bg-[rgba(208, 88, 94, 0.2)] border-[#D0585E] text-white"
