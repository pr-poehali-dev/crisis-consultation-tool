      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="rounded-3xl border border-white/8 p-8 md:p-10 mb-10"
          ...
          <div className="space-y-4 text-gray-300 leading-relaxed text-base md:text-lg">
            <p>
              Мой путь в ресторанном бизнесе начался с должности официанта. Уже через полгода я понял, что моё призвание — за барной стойкой, и стал барменом. За полтора года практики дорос до шеф-бармена, параллельно разрабатывая барные и ресторанные меню для разных заведений.
            </p>
            <p>
              Затем взял на себя роль бар-менеджера и управляющего — так я освоил полный операционный цикл: персонал, закупки, себестоимость, сервис. Именно этот опыт «с земли» даёт мне то, чего нет у большинства консультантов: я знаю, как устроено заведение на каждом уровне.
            </p>
            <p>
