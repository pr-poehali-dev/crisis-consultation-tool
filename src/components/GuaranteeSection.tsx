  ...
  return (
    <section className="py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="glass-card rounded-2xl p-8 md:p-10 border-2 border-[rgba(208, 88, 94, 0.3)] relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-[rgba(208, 88, 94, 0.05)] rounded-full blur-3xl pointer-events-none" />

          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-shrink-0">
              <div className="w-24 h-24 rounded-full bg-[rgba(208, 88, 94, 0.15)] border-2 border-[rgba(208, 88, 94, 0.4)] flex items-center justify-center">
                <Icon name="ShieldCheck" size={48} className="text-[#D0585E]" />
              </div>
            </div>

            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 bg-[rgba(208, 88, 94, 0.1)] border border-[rgba(208, 88, 94, 0.3)] rounded-full px-3 py-1 mb-3">
                <span className="text-[#D0585E] text-xs font-medium uppercase tracking-wider">Гарантия результата</span>
              </div>
          ...
          <div className="relative z-10 mt-8 pt-6 border-t border-white/5 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={item.text} className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[rgba(208, 88, 94, 0.1)] flex items-center justify-center flex-shrink-0">
                  <Icon name={item.icon} size={16} className="text-[#D0585E]" />
                </div>
