...
const CASES = [
  {
    ...
    metrics: [
      ...
      { label: "Выручка/мес", before: "базовая", after: "+112 000 ₽" },
    ],
    weeks: 8,
    icon: "Utensils",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Прибыль/мес", before: "убыток", after: "+54 000 ₽" },
    ],
    weeks: 9,
    icon: "Store",
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Прибыль/мес", before: "убыток", after: "+71 000 ₽" },
    ],
    weeks: 11,
    icon: "Wine",
  ...
  },
  {
    ...
    title: "Открылись по плану и вышли в плюс на 3-й месяц",
    problem: "Запуск нового ресторана итальянской кухни. Не было чёткого понимания бюджета, концепции и операционных норм.",
    solution: "Разработал финансовую модель с нуля: точка безубыточности, план меню, нормы закупок, штатное расписание на старт.",
    result: "Открылись в рамках бюджета 2,3 млн ₽. На 3-й месяц — первая прибыль 61 000 ₽.",
    metrics: [
      { label: "Бюджет открытия", before: "план: 2,7 млн", after: "факт: 2,3 млн" },
      { label: "Выход в плюс", before: "прогноз: 5 мес", after: "факт: 3 мес" },
    ],
    weeks: 14,
    icon: "Star",
  ...
  },
  {
    ...
    title: "Масштабировались без потери качества и стиля",
    problem: "Хотели открыть вторую точку, но первая держалась на ручном управлении собственника — без регламентов и стандартов.",
    solution: "Описали все процессы: рецептуры, стандарты подачи, обучение сотрудников. Создали операционный учебник. Открыли вторую точку по нему.",
    result: "Вторая точка вышла в ноль за 7 недель. Собственник перестал находиться в кофейнях каждый день.",
    metrics: [
      { label: "Выход в ноль", before: "прогноз: 3 мес", after: "факт: 7 недель" },
      { label: "Время владельца", before: "10 ч/день", after: "2 ч/день" },
    ],
    weeks: 12,
    icon: "Pizza",
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">{c.year} г. · {c.weeks} нед. работы</div>
                    </div>
                  </div>
                  <Icon
