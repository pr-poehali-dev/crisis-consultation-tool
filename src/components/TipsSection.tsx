...
const TIPS: Tip[] = [
  ...
  },
  {
    ...
    tag: "Кофейня",
    title: "1 500 или 3 500 за 100 г? Режем правду о цене кофе без анестезии",
    shortDesc: "Где реальная ценность, а где просто красивая упаковка — разбираем без прикрас.",
    content: [
      "**Сначала честно: дорогой ≠ хороший.** Цена на кофе — это не всегда про качество зерна. Это маркетинг, упаковка, аренда склада, бренд и лицо в рекламе. Прежде чем платить 3 500 руб. за 100 г, стоит понять — за что именно вы платите.",
      "**За что берут 1 500 руб.** Среднемассовый спешалти-сегмент. Нормальная обжарка, понятное происхождение, приличный вкус. Для кофейни — рабочая история, если правильно готовить. Большинство гостей не почувствуют разницы между этим и тем, что стоит вдвое дороже.",
      "**За что берут 3 500 руб.** Редкие лоты, конкурсные зёрна, микролоты с конкретной фермы, необычная обработка — анаэробная, карбоник мацерация. Либо — красивая баночка и хайп в Instagram. Вот тут и начинается развод: 70% позиций за 3 500+ — это именно второй вариант.",
      "**Главный вопрос для кофейни: кто мелет и как.** Даже лучшее зерно убивается неправильным помолом. Промышленные жернова нагревают кофе — эфирные масла улетают, аромат теряется ещё до заваривания. Вот почему помол имеет значение не меньше, чем цена зерна.",
      "**Есть ребята, которые делают это иначе — «Люди и зёрна».** Это социальный проект: кофе мелют вручную люди с нарушениями развития. Без нагрева, без спешки, без конвейера. Технология называется «холодный помол» — она сохраняет эфирные масла, естественную сладость и аромат зерна. Такое невозможно воспроизвести на обычном производстве. И это не маркетинговый трюк — это буквально другой продукт.",
      "**Цена у них — честная.** Не 3 500 за бренд. Каждый рубль — это ручной труд, реальная технология и социальная миссия: труд как терапия, работа как право, а не привилегия. Попробовать можно на shop.ludizerna.ru — и сравнить самому.",
      "**Итог для тех, кто закупает кофе в заведение.** Не гонитесь за ценником. Гонитесь за помолом, обжаркой и тем, кто стоит за продуктом. Дешёвое зерно с правильным подходом часто бьёт дорогое, купленное у хайпового бренда. А иногда за 3 500 прячется обычный кофе в красивой банке.",
    ],
  },
  {
