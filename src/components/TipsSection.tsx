    ...
    <>
      <div className="py-6 px-2 w-full">
        <p className="font-oswald text-2xl font-bold text-white uppercase tracking-wide mb-5 px-1">
          СОВЕТЫ ДЛЯ <span style={{ color: "#DB8084" }}>БИЗНЕСА</span>
        </p>
        <div className="flex flex-col gap-3">
          {TIPS.map((tip, i) => (
            <div
              ...
              style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(208, 88, 94, 0.25)" }}
            ...
            >
              ...
              <div className="flex flex-col justify-center py-2 pr-4 gap-1">
                <span className="text-xs font-bold uppercase tracking-wider" style={{ color: "#D0585E" }}>{tip.tag}</span>
          ...
          >
            <div className="relative h-48 overflow-hidden rounded-t-2xl">
              ...
              <div className="absolute bottom-0 left-0 px-7 pb-5">
                <span className="text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-2 inline-block" style={{ background: "#D0585E", color: "#fff" }}>{selected.tag}</span>
            ...
            <div className="px-7 py-6 flex flex-col gap-4">
              ...
              <div className="pt-2 border-t" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
                ...
                <p className="text-sm font-semibold mt-1" style={{ color: "#D0585E" }}>Запишитесь на консультацию с Русланом →</p>
              </div>
            </div>
          </div>
        </div>
