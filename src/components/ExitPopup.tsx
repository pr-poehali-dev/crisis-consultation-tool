...
export default function ExitPopup({ onClose }: ExitPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="glass-card rounded-2xl p-8 max-w-md w-full relative animate-fade-in border border-[rgba(208, 88, 94, 0.3)]">
        <button
          onClick={close}
        ...
        {sent ? (
          <div className="text-center py-4">
            <div className="w-16 h-16 rounded-full bg-[rgba(208, 88, 94, 0.15)] flex items-center justify-center mx-auto mb-4">
              <Icon name="CheckCircle" size={36} className="text-[#D0585E]" />
            </div>
          ...
          <>
            ...
            <div className="space-y-3 mb-4">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-[rgba(208, 88, 94, 0.5)] transition-colors"
              />
              <input
                type="text"
