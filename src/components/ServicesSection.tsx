        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-oswald text-4xl md:text-5xl font-bold uppercase text-white mb-3 tracking-wide">
              МОИ <span style={{ color: "#FFA64D" }}>УСЛУГИ</span>
            </h2>
            <div className="w-16 h-1 mx-auto rounded-full" style={{ background: "#FF7A1A" }} />
              ...
              >
                ...
                <button
                  ...
                  onMouseLeave={e => {
                    ...
                    (e.currentTarget as HTMLButtonElement).style.color = "#FFA64D";
                  }}
                >
                  Подробнее
                </button>
      ...
      {selected && (
        ...
        >
          <div
            ...
            style={{ background: "#241a10", border: "1px solid rgba(255, 122, 26, 0.3)" }}
            onClick={e => e.stopPropagation()}
          >
            <div className="px-7 py-5 rounded-t-2xl" style={{ background: "#FF7A1A" }}>
            ...
            <div className="px-7 py-6 flex flex-col gap-6">
                ...
                <ul className="flex flex-col gap-2">
                  {selected.blocks.map((b, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm text-gray-300">
                      <span style={{ color: "#FFA64D" }} className="mt-0.5 flex-shrink-0">•</span>
                      {b}
                    </li>
                  ))}
                </ul>
              ...
              {selected.callout && (
                <p className="font-semibold text-white text-sm italic border-l-4 pl-4" style={{ borderColor: "#FF7A1A" }}>
                  {selected.callout}
                </p>
              )}
              ...
              <div className="rounded-xl p-5 flex flex-col gap-4" style={{ background: "rgba(255, 122, 26, 0.08)", border: "1px solid rgba(255, 122, 26, 0.25)" }}>
                {sent ? (
