...
const FAQS = [
  ...
  {
    q: "Я уже работал с консультантами — не помогло. Почему сейчас будет иначе?",
    a: "Потому что я не продаю универсальные методики. Каждый разбор — это конкретные цифры вашего заведения, конкретные точки потерь и конкретный план. Если на диагностике я не увижу, чем могу помочь — скажу об этом честно.",
  },
];
