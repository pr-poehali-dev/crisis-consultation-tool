...
export default function DiagnosticQuiz({ diagRef }: DiagnosticQuizProps) {
  ...
  return (
    <section
      ...
      id="diagnostics"
      className="py-16 px-4 bg-[#150808]"
    >
      <div className="max-w-2xl mx-auto">
        ...
        {step === "intro" && (
          <div className="glass-card rounded-2xl p-8 text-center">
            <div className="w-16 h-16 rounded-2xl bg-[rgba(184,115,61,0.15)] flex items-center justify-center mx-auto mb-5">
              <Icon name="ClipboardList" size={32} className="text-[#B8733D]" />
            </div>
            ...
            <div className="flex justify-center gap-6 my-6 text-sm flex-wrap">
              <div className="flex items-center gap-2 text-gray-400">
                <Icon name="Clock" size={16} className="text-[#B8733D]" />
                5–7 минут
              </div>
              <div className="flex items-center gap-2 text-gray-400">
                <Icon name="Gift" size={16} className="text-[#B8733D]" />
                Бесплатно
              </div>
              <div className="flex items-center gap-2 text-gray-400">
                <Icon name="BarChart2" size={16} className="text-[#B8733D]" />
                Личный разбор
              </div>
            </div>
            <button
              ...
              {INFO_FIELDS.map((f) => (
                <div key={f.id}>
                  ...
                  <input
                    ...
                    className={`w-full bg-white/5 border rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#B8733D] transition-colors ${
        ...
        {step === "quiz" && (
          <div className="glass-card rounded-2xl overflow-hidden">
            <div className="h-1 bg-white/5">
              <div className="h-full bg-[#B8733D] transition-all duration-500" style={{ width: `${progress}%` }} />
            </div>
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                <span className="text-[#B8733D] text-sm font-semibold">
                ...
                {q.options.map((opt) => (
                  <button
                    ...
                    className={`w-full text-left px-5 py-4 rounded-xl border transition-all duration-200 disabled:opacity-50 ${
                      answers[q.id] === opt
                        ? "border-[#B8733D] bg-[rgba(184,115,61,0.12)] text-white"
                        : "border-white/10 bg-white/3 text-gray-300 hover:border-[#B8733D]/50 hover:bg-[rgba(184,115,61,0.06)]"
                    }`}
                  >
                    {opt}
                  </button>
        ...
        {step === "done" && (
          <div className="glass-card rounded-2xl p-8 text-center">
            ...
            {/* Мотивация */}
            <div className="bg-gradient-to-br from-[rgba(184,115,61,0.12)] to-[rgba(184,115,61,0.06)] border border-[rgba(184,115,61,0.25)] rounded-2xl p-5 mb-5 text-left">
              <p className="text-[#B8733D] font-bold text-sm mb-2">💬 Слово от Руслана:</p>
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-gray-400 mb-5">
              <Icon name="CheckCircle" size={16} className="text-[#B8733D]" />
